...
public class StoreDAO {
    ...
    public List<StoreDTO> selectInfo() {
        ...
        String sql = "SELECT name, address, rating, category,latitude,longitude FROM store ORDER BY name";
    ...
    public List<StoreDTO> selectInfoByCategory(String category) {
        ...
        List<StoreDTO> list = new ArrayList<>();
        // Include latitude and longitude so that map markers can be generated properly
        String sql = "SELECT name, address, rating, category, latitude, longitude "
                   + "FROM store WHERE category = ? ORDER BY name";
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        try {
            ...
            while (rs.next()) {
                ...
                vo.setRating(rs.getDouble("rating"));
                vo.setCategory(rs.getString("category"));
                // Set latitude/longitude when present
                try {
                    vo.setLatitude(rs.getDouble("latitude"));
